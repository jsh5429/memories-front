...
export default function RecentlyConcentration() {
    ...
    const [concentrationTests, setConcetrationTests] = useState<ConcentrationTest[]>([]);

    // variagle : access token //
    ...
    const getRecentlyConcentrationResponse = (responseBody : 
        GetRecentlyConcentrationResponseDto | ResponseDto | null) => {
            ...
            setConcetrationTests(concentrationTests.reverse());
    }
    ...
    useEffect(()=> {
        ...
        getRecentlyConcentrationRequest(accessToken).then
        (getRecentlyConcentrationResponse)
    },[])

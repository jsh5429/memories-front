...
import { ACCESS_TOKEN, CONCENTRATION_TEST_ABSOLUTE_PATH, MEMORY_TEST_ABSOLUTE_PATH } from 'src/constants';
...
export default function RecentlyMemory() {
    ...
    const getRecentlyMemoryResponse = (responseBody :
        GetRecentlyMemoryResponseDto | ResponseDto | null
    ) =>{
        const message =
